...
if __name__ == "__main__":
    ...
    for i in range(1, 3):
        ...
        save_model_path = f"./models/KR_GoogleNet_SeNet/senet_model_{i}.pt"
        save_history_path = f"./models/KR_GoogleNet_SeNet/senet_history_{i}.pt"
    ...
    output_df.to_excel(f'./senet_results.xlsx', index=False)
